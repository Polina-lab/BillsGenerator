  ...
  <div class="container-fluid" >
    <div class="invoice-box" :class="{ 'text-mode-width': previewData.is_pdf_pic_mode }">
      <table class="main-table" cellpadding="0" cellspacing="0">
        <tr class="top z__index">
          <td colspan="2">
            <div class="table__top">
              <table>
                <tr><img :src="setImageFon" class="wallpaper"></tr>
                <tr>
                  <td>
                    <img class="left__img" :src="setImageWreath" alt="Merry Chistmas!"/>
                  </td>
                  <td class="title">
        ...
        <tr>
          <td colspan="2">
            <div class="table__reffered z__index">
              <table>
                <thead>
                  <tr>
          ...
          <td colspan="2">
            <table class="table__gray">
              <thead>
                <tr>
                  <th class="text-left">
                    <img :src="setImage4" class="img__4"><span>{{ $t('bills.explanation', previewData.locale )}}</span></th>
                  ...
                  <th class="text-right"><span>{{ $t('bills.total', previewData.locale ) }}</span>
                    <img :src="setImage5" class="img__5">
                  </th>
                </tr>
              </thead>
              <tbody>
              ...
              <tfoot>
                ...
                <tr class="blue__fon">
                  <td colspan="2"><img :src="setImage1" class="img__1"></td>
                  <td><img :src="setImage2" class="img__2"></td>
      ...
      <tfoot class="z__index">
        <tr>
          ...
          <td rowspan="4"><img class="snow3__img" :src="setImage3" alt="Snow."></td>
        </tr>
        <tr>
          <td>
            <div class="gray__p">
        ...
        <tr>
          <td>
            <p class="text-left gray__p line__height">
        ...
        <tr>
          <td colspan="2" class="blue__row"></td>
        </tr>
        </tfoot>
      </table>
...
import { Snow5 }  from "../../assets/js/base64/Snow5";
import { Snow4 }  from "../../assets/js/base64/Snow4";
import { Snow3 }  from "../../assets/js/base64/Snow3";
import { Snow2 }  from "../../assets/js/base64/Snow2";
import { Snow1 }  from "../../assets/js/base64/Snow1";
import { SnowFon }  from "../../assets/js/base64/SnowFon";
import { Wreath }  from "../../assets/js/base64/Wreath";

export default {
  name: "previewComponent6",
  props: ["previewData"],
...
.table__gray thead tr th:last-of-type span{
  padding-right: 5px;
}
.table__gray thead tr th:first-of-type span{
  padding-left: 5px;
}
.text-right{
   position: relative;
