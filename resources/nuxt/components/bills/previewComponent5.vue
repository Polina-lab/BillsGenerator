  ...
  <div class="container-fluid" >
    <div class="invoice-box" :class="{ 'text-mode-width': previewData.is_pdf_pic_mode }">
      <table class="main-table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="title">
                    ...
                    <div v-else class="alt__error"  @click="updateTest($event)">
                      ...
                      <img :src="setImage2" class="static__img" :alt="previewData.firms.company_name">
                    </div>
                  </td>
                  <td>
        ...
        <tr>
          <td colspan="2">
            <div class="back__gradient"><img :src="setImage4"></div>
          </td>
        </tr>
          ...
          <td colspan="2">
            <table class="table__green">
              ...
              <tfoot>
                ...
                <tr class="green__gradient"><td colspan="5"><img :src="setImage5"></td></tr>
                <tr>
                  <td colspan="3"></td>
                ...
                <tr>
                  <td colspan="5" class="text-center green__text">
      ...
      <tfoot>
        <tr>
          <td colspan="2">
            <div class="img__box">
              <img :src="setImage3" class="green__img">
            </div>
          </td>
        </tr>
        <tr>
...
import { March1 }  from "../../assets/js/base64/March1";
import { March2 }  from "../../assets/js/base64/March2";
import { March3 }  from "../../assets/js/base64/March3";
import { BackGradient }  from "../../assets/js/base64/BackGradient";
import { Gradient }  from "../../assets/js/base64/Gradient";

export default {
  name: "previewComponent5",
  props: ["previewData"],
